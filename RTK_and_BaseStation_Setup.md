...
Step 1. Plug Blue/Green wire from the RTK connection into "CAN1" on the CubeOrange, the Here4 RTK should begin blinking indicating that it is searching.
...
###############Steps 5-10 should already be configured on the CubeOrang###############
...
Step 11. Click "Setup" -> "Optional Hardware" -> "GPS/RTK inject".
...
In order to check the output of the RTK and also the relative accuracy, you can hit cntrl+F, then "Mavlink inspector". 

<img width="723" height="552" alt="image" src="https://github.com/user-attachments/assets/6d2e0549-92dd-47e1-8bdf-4b964366fd19" />

Also the "No GPS" should switch to "RTK float" when working properly.

<img width="499" height="377" alt="image" src="https://github.com/user-attachments/assets/e2632a6c-d80b-40be-8bbc-6a373c9b4d43" />
